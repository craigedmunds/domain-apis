        ...
        from("direct:getSubmission")
                    ...
                    if (rawQuery != null) {
                        for (String param : rawQuery.split("&")) {
                            if (param.startsWith("fields%5Bsubmission-returns%5D=")
                                ...
                                fieldsParam = java.net.URLDecoder.decode(
                                        value, java.nio.charset.StandardCharsets.UTF_8);
                                break;
                            }
                        }
                    }
                    exchange.setProperty("fieldsParam", fieldsParam);
                })
                ...
                .choice()
                    ...
                    .when(PredicateBuilder.and(
                            exchangeProperty("approvalNumber").isNotNull(),
                            exchangeProperty("periodKey").isNotNull()))
